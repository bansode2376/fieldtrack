...
const ASSETS=['./','./index.html','./style.css','./app.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png','./screenshots/mobile-720x1280.png','./screenshots/desktop-1280x720.png'];
